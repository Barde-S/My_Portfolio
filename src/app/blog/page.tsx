...
export default async function BlogPage() {
  ...
  const dateA = new Date(a.metadata.publishedAt); // Use a.metadata.publishedAt
  const dateB = new Date(b.metadata.publishedAt); // Use b.metadata.publishedAt
  ...
  return dateB.getTime() - dateA.getTime(); // Compare timestamps (in milliseconds)
});
